...
async function main() {
  const argv = (await yargs(hideBin(process.argv))
    .command('init', 'Initialize a new project', (yargs: Argv) => {
      return yargs
        .option('name', {
    ...
    .command('start', 'Start the project', (yargs: Argv) => {
      return yargs
        .option('port', {
    ...
    .command('test', 'Run tests', (yargs: Argv) => {
      return yargs
        .option('coverage', {
    ...
    .command('deploy', 'Deploy the project', (yargs: Argv) => {
      return yargs
        .option('target', {
    ...
    .command('clean', 'Clean the project', (yargs: Argv) => {
      return yargs
        .option('all', {
